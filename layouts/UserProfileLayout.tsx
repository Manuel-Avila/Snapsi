...
export default function UserProfileLayout({ actionsSection }) {
      ...
      <View style={styles.profileInfoContainer}>
        ...
        <View>
          ...
          <Text>
            ...
            elit. Autem, accusamus voluptates. Itaque omnis officia perferendis
            dolore voluptatum exercitationem error quod nulla fuga officiis
            nihil architecto ipsum vel, nesciunt distinctio quia!
          </Text>
        </View>
      </View>
      {actionsSection}
